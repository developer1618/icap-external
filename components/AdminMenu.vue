...
<template>
  <div class="sidebar bg-[#0A7194] text-white flex h-full pr-12 pl-6 py-8 flex-col items-between justify-between">
    ...
    <svg style="display: none" width="10" height="10">
      <symbol id="vector-1" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_597_4017)">
          <path
        ...
        <defs>
          <clipPath id="clip0_597_4017">
            <rect width="24" height="24" fill="white" />
          </clipPath>
        </defs>
      </symbol>
      <symbol id="vector-2" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_566_4097)">
          <path
        ...
        <defs>
          <clipPath id="clip0_566_4097">
            <rect width="24" height="24" fill="white" />
          </clipPath>
        </defs>
      </symbol>
      <symbol id="vector-3" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_566_4106)">
          <path
        ...
        <defs>
          <clipPath id="clip0_566_4106">
            <rect width="24" height="24" fill="white" />
          </clipPath>
        </defs>
      </symbol>
      <symbol id="vector-4" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_566_4115)">
          <path
        ...
        <defs>
          <clipPath id="clip0_566_4115">
            <rect width="24" height="24" fill="white" />
          </clipPath>
        </defs>
      </symbol>
      <symbol id="vector-5" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_566_4124)">
          <path
        ...
        <defs>
          <clipPath id="clip0_566_4124">
            <rect width="24" height="24" fill="white" />
          </clipPath>
        </defs>
      </symbol>
      <symbol id="vector-6" viewBox="0 0 24 24">
        <g clip-path="url(#clip0_566_4131)">
          <path
    ...
    <div class="h-full">
      <div class="sidebar_navigation">
        <nav>
          <ul>
            <li class="pb-8 flex gap-5" v-for="nav in navigation">
              <nuxt-link class="flex gap-x-4" :to="nav.url">
                <svg>
                  <use :xlink:href="nav.icon"></use>
                </svg>
                <span class="text-lg font-semibold whitespace-nowrap">{{ nav.title }}</span>
              </nuxt-link>
            </li>
          </ul>
        </nav>
